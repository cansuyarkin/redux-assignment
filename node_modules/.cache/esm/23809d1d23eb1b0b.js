_23e‍.x([["addPost",()=>addPost],["removePost",()=>removePost],["updatePost",()=>updatePost],["addComment",()=>addComment],["removeComment",()=>removeComment],["removeUserComments",()=>removeUserComments],["addUpVote",()=>addUpVote],["addDownVote",()=>addDownVote],["default",()=>_23e‍.o]]);// {id, title, comments: [{id: 1, userId: 1, comment: "d"}], {votes: {up: 0, down:0 } } }
...
// ACTION CREATORS
    ...
    payload: { id, title },
       ...
       const addComment = (id, commentId, userId, comment) => ({
    type: ADD_COMMENT,
